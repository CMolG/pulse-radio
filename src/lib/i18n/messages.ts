...
export type MessageKey = keyof typeof BASE_MESSAGES; export type MessageBundle = Record<MessageKey, string>; const DEEP_MESSAGES: Partial<Record<SupportedLocale, Partial<MessageBundle>>> = { es: {
    ...
    searchStations: "Buscar emisoras…", searchStationsAria: "Buscar emisoras", searchResultLabel: "Búsqueda: \"{query}\"", retry: "Reintentar",
    ...
    searchStationsAria: "Buscar estações", retry: "Tentar novamente", failedToLoad: "Falha ao carregar", noStationsFound: "Nenhuma estação encontrada",
  ...
  pt: { loadingStations: "A carregar…", stationCount: "{count} estações", allCountries: "Todos", favorites: "Favoritos",
    ...
    searchStationsAria: "Pesquisar estações", retry: "Tentar novamente", failedToLoad: "Falha ao carregar", noStationsFound: "Nenhuma estação encontrada",
