...
const BASE_MESSAGES = {
  topStations: "Top Stations", loadingStations: "Loading…",
  stationCount: "{count} stations", discovery: "Discovery",
  discoveryOn: "ON", discoveryModeAria: "Discovery mode",
  discoveryModeTitle: "Auto-play a random station every 30 seconds", all: "All",
  allCountries: "All", favorites: "Favorites",
  recent: "Recent", discover: "Discover",
  ...
  noiseReduction: "Noise Reduction", audioNormalizer: "Audio Normalizer",
  ...
  genreTrending: "Trending", genrePop: "Pop",
  genreRock: "Rock", genreJazz: "Jazz",
  genreClassical: "Classical", genreElectronic: "Electronic",
  genreHiphop: "Hip-Hop", genreCountry: "Country",
  genreAmbient: "Ambient", genreLofi: "Lo-Fi",
  genreNews: "News", genreLatin: "Latin",
  genreMetal: "Metal", genreLocal: "Local",
  genreWorld: "World", seeMore: "See more",
} as const;
...
const DEEP_MESSAGES: Partial<Record<SupportedLocale, Partial<MessageBundle>>> = {
  es: {
    topStations: "Top Stations", loadingStations: "Cargando…",
    stationCount: "{count} emisoras", discovery: "Descubrir",
    all: "Todo", allCountries: "Todos",
    favorites: "Favoritos", recent: "Recientes",
    ...
    genreClassical: "Clásica", genreElectronic: "Electrónica",
    genreNews: "Noticias", genreLatin: "Latina",
    genreLocal: "Local", minimize: "Minimizar",
    expand: "Expandir", seeMore: "Ver más",
  },
  fr: {
    loadingStations: "Chargement…", stationCount: "{count} stations",
    allCountries: "Tous", favorites: "Favoris",
    recent: "Récents", discover: "Découvrir",
    history: "Historique", searchStations: "Rechercher des stations…",
    searchStationsAria: "Rechercher des stations", retry: "Réessayer",
    failedToLoad: "Échec du chargement", noStationsFound: "Aucune station trouvée",
    previous: "Préc.", next: "Suiv.",
    addToFavorites: "Ajouter aux favoris", removeFromFavorites: "Retirer des favoris",
    minimize: "Réduire", expand: "Agrandir",
  },
  de: {
    loadingStations: "Laden…", stationCount: "{count} Sender",
    allCountries: "Alle", favorites: "Favoriten",
    recent: "Zuletzt", discover: "Entdecken",
    history: "Verlauf", searchStations: "Sender suchen…",
    searchStationsAria: "Sender suchen", retry: "Erneut versuchen",
    failedToLoad: "Laden fehlgeschlagen", noStationsFound: "Keine Sender gefunden",
  ...
  "pt-BR": {
    loadingStations: "Carregando…", stationCount: "{count} estações",
    allCountries: "Todos", favorites: "Favoritos",
    recent: "Recentes", discover: "Descobrir",
    history: "Histórico", searchStations: "Buscar estações…",
  ...
  pt: {
    loadingStations: "A carregar…", stationCount: "{count} estações",
    allCountries: "Todos", favorites: "Favoritos",
    recent: "Recentes", discover: "Descobrir",
    history: "Histórico", searchStations: "Pesquisar estações…",
  ...
  ja: {
    loadingStations: "読み込み中…", stationCount: "{count} 局",
    allCountries: "すべて", favorites: "お気に入り",
    recent: "最近", discover: "発見",
    history: "履歴", searchStations: "ラジオ局を検索…",
    searchStationsAria: "ラジオ局を検索", retry: "再試行",
    failedToLoad: "読み込みに失敗しました", noStationsFound: "局が見つかりません",
    previous: "前へ", next: "次へ",
    minimize: "最小化", expand: "展開",
  },
  ar: {
    loadingStations: "جارٍ التحميل…", stationCount: "{count} محطة",
    allCountries: "الكل", favorites: "المفضلة",
    recent: "الأخيرة", discover: "اكتشاف",
    history: "السجل", searchStations: "ابحث عن المحطات…",
    searchStationsAria: "ابحث عن المحطات", retry: "إعادة المحاولة",
    failedToLoad: "فشل التحميل", noStationsFound: "لم يتم العثور على محطات",
