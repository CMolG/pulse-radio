/* Copyright (c) 2026 Carlos Molina Galindo. Open source: Pulse Radio. */ export type SovereignCountry =
  {
    code: string;
    name: string;
    region: string;
...
export const SOVEREIGN_COUNTRIES: SovereignCountry[] = [
  ...
  },
  {
    ...
    subregion: 'Southern Africa',
    borders: ['AO', 'BW', 'ZA', 'ZM'],
    lang3: ['afr', 'deu', 'eng', 'her', 'hgm', 'kwn', 'loz', 'ndo', 'tsn'],
  },
  {
    code: 'NE',
    name: 'Niger',
  ...
  },
  {
    ...
    lang3: ['afr', 'eng', 'nbl', 'nso', 'sot', 'ssw', 'tsn', 'tso', 'ven', 'xho', 'zul'],
  },
  {
    code: 'ZM',
    name: 'Zambia',
...
export const SOVEREIGN_COUNTRY_CODES: string[] = [];
export const COUNTRY_BY_CODE: Record<string, SovereignCountry> = {};
for (const country of SOVEREIGN_COUNTRIES) {
  SOVEREIGN_COUNTRY_CODES.push(country.code);
