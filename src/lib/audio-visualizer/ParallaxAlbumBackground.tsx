...
interface ParallaxAlbumBackgroundProps {
  ...
  blurClass?: string; overlayClass?: string;
  enableDrift?: boolean; showTopGlow?: boolean;
  children?: React.ReactNode;
}

export function ParallaxAlbumBackground({
  imageUrl, fallbackUrl,
  blurClass = 'blur-2xl', overlayClass = 'bg-black/50',
  enableDrift = true, showTopGlow = true,
  children,
