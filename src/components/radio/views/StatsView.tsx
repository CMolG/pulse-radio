...
import { Clock, Radio as RadioIcon, Music, User, Disc3 } from 'lucide-react';
import type {
  StationListenTime,
  SongPlayCount,
  ArtistPlayCount,
...
export const StatSection = React.memo(function StatSection({
  title,
  icon,
  children,
}: {
...
export const BarRow = React.memo(function BarRow({
  label,
  value,
  maxValue,
  suffix,
