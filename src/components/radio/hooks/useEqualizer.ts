...
import type { EqBand, EqPreset, NoiseReductionMode } from '../constants';
import { STORAGE_KEYS, EQ_BANDS } from '../constants';
...
export function useEqualizer() {
  ...
  const graphNodeRefs: MutableRefObject<AudioNode | null>[] = [
    normalizerRef,
    normGainRef,
    limiterRef,
    splitterRef,
