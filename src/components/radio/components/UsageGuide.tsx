...
import { IoRadioOutline, IoHeartOutline, IoMusicalNotesOutline, IoStatsChartOutline, IoSearchOutline, IoColorPaletteOutline, IoTimerOutline, IoGlobeOutline, IoChevronBack } from 'react-icons/io5'; const GLASS_STYLE: React.CSSProperties = {
...
type GuideSection = { icon: React.ReactNode; title: string; content: string; }; const GUIDE_SECTIONS: GuideSection[] = [
  ...
  }, { icon: <IoHeartOutline size={22} className="text-pink-400" />, title: 'Favorites', content: 'Tap the star to save stations. Tap the heart to save songs. Filter your favorite songs by artist — songs are grouped in stacks you can expand.',
  ...
  }, { icon: <IoTimerOutline size={22} className="text-orange-400" />, title: 'Sleep Timer', content: 'Press Z or use the timer icon to cycle through sleep durations (15, 30, 60, 90 min). Pulse will automatically stop playback when the timer ends.',
