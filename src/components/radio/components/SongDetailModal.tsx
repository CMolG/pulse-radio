      ...
      {song && (
        ...
        >
          <motion.div
            ...
            className="bg-surface-2 rounded-2xl border border-border-default shadow-2xl w-full max-w-[380px] max-h-[85vh] overflow-y-auto mx-4 [&::-webkit-scrollbar]:hidden [scrollbar-width:none]"
