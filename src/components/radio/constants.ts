...
export const GENRE_GRADIENTS: Record<string, string> = {
  ...
  electronic: 'linear-gradient(135deg, #06b6d4, #2563eb)', hiphop: 'linear-gradient(135deg, #5a5a5a, #3a3a3a)',
  country: 'linear-gradient(135deg, #d97706, #c2410c)', ambient: 'linear-gradient(135deg, #14b8a6, #059669)',
